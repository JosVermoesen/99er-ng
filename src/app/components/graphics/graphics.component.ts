...
export class GraphicsComponent implements OnInit, AfterViewInit, OnChanges {
    ...
    ngAfterViewInit() {
        this.paletteCanvas =
            this.element.nativeElement.querySelector("#palette-canvas");
        this.tileCanvasTop =
            this.element.nativeElement.querySelector("#tile-canvas-top");
        this.tileCanvasMiddle = this.element.nativeElement.querySelector(
            "#tile-canvas-middle"
        );
        this.tileCanvasBottom = this.element.nativeElement.querySelector(
            "#tile-canvas-bottom"
        );
        this.spriteCanvas =
            this.element.nativeElement.querySelector("#sprite-canvas");
    }
