...
export class MainControlsComponent implements OnInit, OnDestroy {
    ...
    primeVideoButtons = false;
    primeRightButtons = true;
    ...
    primeVideoButtonsToggle() {
        this.primeVideoButtons = !this.primeVideoButtons;
    }

    primeRightButtonsToggle() {
        this.primeRightButtons = !this.primeRightButtons;
    }
